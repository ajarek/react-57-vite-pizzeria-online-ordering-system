...
const InfoSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <li>
          Monday <span>24h</span>
        </li>
        <li>
          Tuesday <span>24h</span>
        </li>
        <li>
          Wednesday <span>24h</span>
        </li>
        <li>
          Thursday <span>24h</span>
        </li>
        <li>
          Friday <span>24h</span>
        </li>
        <li>
          Saturday <span>24h</span>
        </li>
        <li>
          Sunday <span>24h</span>
        </li>
        <select
        ...
        >
          ...
          <option value=''>20/12/2022 Closed</option>
        </select>
      </InfoPanel>
      <InfoPanel
      ...
      >
        ...
        <li className='country'>
          <div>
            <a href='tel:+48573219230'>+48 573219230</a>
          </div>
        </li>
      </InfoPanel>
    </div>
